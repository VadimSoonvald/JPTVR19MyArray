...
class App {
    void run(){
        ...
        System.out.println("Создать массив int c названием MyArray с 20 ячейками");
        ...
        System.out.println("Вывести значения массива на экран в обратном порядке");
        for(int i = myArray.length-1; i>=0; i--){
            System.out.printf("%3d",myArray[i]);
        } System.out.println();
        System.out.println("Суммая ячеек: ");
        for(int i = 0; i < myArray.length; i++){
            sum = sum + myArray[i];
